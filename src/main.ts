...
export default class CodeImportPlugin extends Plugin {
  ...
  onunload() {
    ...
    activeDocument.body.removeClass('code-import-show-filename');
    activeDocument.body.removeClass('code-import-wrap-enabled');
  }
  ...
  updateBodyClasses() {
    activeDocument.body.toggleClass('code-import-show-filename', this.settings.showFileName);
    activeDocument.body.toggleClass('code-import-wrap-enabled', this.settings.wrapCode);
  }
  ...
  private async replaceImportDirectives(
    ...
    for (const result of parseResults) {
      ...
      if (result.startIndex > lastIndex) {
        ...
        fragment.appendChild(activeDocument.createTextNode(beforeText));
      }
    ...
    if (lastIndex < text.length) {
      ...
      fragment.appendChild(activeDocument.createTextNode(afterText));
    }
